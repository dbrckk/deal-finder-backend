...
def search_showroomprive(keyword):
    url = f"https://www.showroomprive.com/search/{keyword}"
    products=[]
    try:
        ...
        for item in items[:MAX_PER_SITE]:
            ...
            link = "https://www.showroomprive.com"+link_tag.get("href") if link_tag else None
            product={
