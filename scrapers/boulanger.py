...
def search_boulanger(keyword):
    url = f"https://www.boulanger.com/resultats?search={keyword}"
    products=[]
    try:
        ...
        for item in items[:MAX_PER_SITE]:
            ...
            link = "https://www.boulanger.com"+link_tag.get("href") if link_tag else None
            product={
